...
with open(os.path.join(projectfolder, "devs.csv"), 'w', newline='', encoding='utf-8') as csvfile:
...
with open(os.path.join(projectfolder, "devs.csv"), 'r', newline='', encoding='utf-8') as csvfile:
...
df.to_csv(os.path.join(projectfolder, "devs_similarity.csv"), index=False, header=True)
...
df.to_csv(os.path.join(projectfolder, f"devs_similarity_t={t}.csv"), index=False, header=True)
